...
def camera2word(cam_coordinate,  RT):
    """
    :param cam_coordinate: [num_point, 6]
    :param RT:[4,3] rotation and translation matrix
    """

    #获取相机坐标系下的每个点的后三列RGB值
    camera_rgb = cam_coordinate[:,3:6]
    ...
    #将wx, xy, wz, R, G, B 拼接：[num_point, 3] -> [num_point, 6]
    c2w_rgb = np.c_[c2w, camera_rgb]
    return c2w_rgb
